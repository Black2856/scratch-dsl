...
| motion-basic | 座標移動 | `motion_movesteps`, `motion_gotoxy` | costume | 必須 | 必須 | 必須 | 必須 | 必須 |
...
| pen-basic | pen描画 | `pen_clear`, `pen_penDown`, `pen_penUp`, `pen_setPenSizeTo`, motion | costume任意 | 必須 | 必須 | 必須 | 必須 | 必須 |
